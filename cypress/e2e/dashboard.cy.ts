describe('Dashboard Test', () => {
  ...
  it('should find 3 restaurant cards in order by distance', () => {
    ...
    cy.get(
      '#card-2 > :nth-child(1) > .col-md-8 > .card-body > .row > :nth-child(1) > .card-text.small-text > span'
    ).contains('0.01 miles')
    cy.get('#card-3').should('exist')
    cy.get(
      '#card-3 > :nth-child(1) > .col-md-8 > .card-body > .row > :nth-child(1) > .card-text.small-text > span'
    ).contains('0.06 miles')
    cy.get('#card-1').should('exist')
    cy.get(
      '#card-1 > :nth-child(1) > .col-md-8 > .card-body > .row > :nth-child(1) > .card-text.small-text > span'
    ).contains('0.27 miles')
  })
  ...
  it('should find the initial details for a restaurant on its card', () => {
    ...
    cy.get(
      '#card-1 > :nth-child(1) > .col-md-8 > .card-body > .row > .label-container > .blue'
    ).should('exist')
    cy.get(
      '#card-1 > :nth-child(1) > .col-md-8 > .card-body > .row > .label-container > .blue'
    ).should('exist')
  ...
  it('should find a button to click for more details', () => {
    ...
    cy.get('[style="text-align: center;"] > .mb-3').contains('9600 Kitchen')
    cy.get('[style="text-align: center;"] > :nth-child(2)').contains(
      '550 Village Rd Breckenridge, CO 80424'
    )
    cy.get(
      '.d-flex > :nth-child(1) > [style="letter-spacing: 0.3rem;"]'
    ).contains('American')
    cy.get('[style="margin: 1rem;"] > .card-text > span').contains('0.27 miles')
    cy.get('.modal-body > :nth-child(1) > :nth-child(4)').should('exist')
    cy.get('[style="text-align: center;"] > .m-4').contains(
